// BT1/ Đảo ngược một chuỗi VD:"My name is Phan Dat" -> "Phan Dat is name My"
...
console.log(reverseString("My name is Phan Dat"));
...
// BT3/ In hoa chữ cái đầu trong chữ VD: "my name is phan Dat" -> "My Name Is Phan Dat"
...
console.log(capitalizeStr("phan thanh dat"));
